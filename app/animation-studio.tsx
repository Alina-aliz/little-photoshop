...
import { Brush, ChevronDown, ChevronLeft, ChevronRight, ChevronUp, Copy, Download, Droplets, Eraser, Eye, EyeOff, Film, Focus, Ghost, GripHorizontal, ImagePlus, Lock, Music2, Pause, Pipette, Play, Plus, Redo2, Scissors, SkipBack, SkipForward, Sparkles, Trash2, Type as TypeIcon, Undo2, Unlock, Video } from 'lucide-react';
