...
import { Brush, ChevronLeft, ChevronRight, Copy, Download, Eraser, Eye, EyeOff, Film, Ghost, ImagePlus, Lock, Music2, Pause, Play, Plus, Redo2, Scissors, SkipBack, SkipForward, Sparkles, Trash2, Undo2, Unlock } from 'lucide-react';
